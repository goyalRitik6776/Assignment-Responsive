    ...
    <div className="self-stretch flex flex-col items-start justify-start text-left text-base text-gray-700 font-text-sm-medium1 py-0 px-4 gap-[20px] lg:flex lg:flex-row lg:mt-[-20px]">
      ...
      <div className="self-stretch rounded-xl bg-white shadow-[0px_1px_3px_rgba(16,_24,_40,_0.1),_0px_1px_2px_rgba(16,_24,_40,_0.06)] overflow-hidden flex flex-col items-start justify-start text-gray-600 border-[1px] border-solid border-gray-200 lg:w-3/4">
        <form className="self-stretch bg-white flex flex-col py-5 px-4 items-start justify-start gap-[24px]">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[6px] lg:w-1/2 overflow-hidden">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[6px]">
            ...
            <div className="self-stretch rounded-lg border-[1px] border-solid border-gray-300 flex ">
              ...
              <input className="self-stretch rounded-lg border-none bg-white py-2.5 px-3.5 gap-[8px] text-gray-900 leading-[24px] font-medium font-text-sm-medium1 text-[14px] focus:outline-none w-full" type="email" defaultValue="olivia@untitledui.com" placeholder="Email"/>
            </div>
          </div>
        ...
        <div className="self-stretch flex flex-col pt-0 px-0 pb-3 items-center justify-start gap-[12px]">
          ...
          <div className="self-stretch flex flex-row py-0 px-4 items-center justify-end gap-[16px]">
            <div className="flex-1 flex flex-row items-center justify-end gap-[12px]">
              <button className="cursor-pointer py-2.5 px-4 bg-base-white1 rounded-lg shadow-[0px_1px_2px_rgba(16,_24,_40,_0.05)] overflow-hidden flex flex-row items-center justify-center gap-[8px] border-[1px] border-solid border-gray-300 transition ease-in duration-200 hover:bg-[#F9FAFB]">
