const Header = () => {
  return (
    <nav className="self-stretch bg-base-white1 box-border h-16 shrink-0 flex flex-col items-center justify-start border-b-[1px] border-solid border-gray-2001">
